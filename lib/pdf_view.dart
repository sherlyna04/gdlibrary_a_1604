...
import 'package:gdlibrary_a_1604/invoice/get_total_invoice.dart';
import 'package:gdlibrary_a_1604/invoice/model/custom_row_invoice.dart';
import 'package:gdlibrary_a_1604/invoice/model/product.dart';
import 'package:barcode_widget/barcode_widget.dart';
import 'package:gdlibrary_a_1604/preview_screen.dart';
import 'package:gdlibrary_a_1604/invoice/item_doc.dart';
...
final List<CustomRow> elements = [
  CustomRow("itemName", "itemPrice", "amount", "subTotalProduct"),
  for (var product in soldProducts)
    ...
    CustomRow(
      ...
      "",
      "",
      "Rp ${(double.parse(getSubTotal(soldProducts)) + 
double.parse(getPPNTotal(soldProducts))).toStringAsFixed(2)}",
    )
];
